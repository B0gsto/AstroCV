---
title: "Four enterprise automations"
description: "Four enterprise UiPath systems delivered solo: OAuth, pagination, rate limits, retries with backoff, and one REFramework standard across projects."
